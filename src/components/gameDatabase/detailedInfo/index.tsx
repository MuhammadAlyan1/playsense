...
const legendsInfo: legendInfo[] = [
  {
    ...
    abilities: {
      passive: {
        ...
        cooldown: '',
        additionalInfo: [
          'Revealing a Care Package with the Skirmisher perk decreases Pathfinder’s Zipline Gun Zipline Gun cooldown by 10 seconds.'
        ]
      },
      tactical: {
        name: 'Grappling Hook',
  ...
  },
  {
    ...
    abilities: {
      ...
      tactical: {
        ...
        description:
          'Launch your winged companion Echo to a designated location. You can then launch yourself towards Echo’s position, repositioning quickly.',
        cooldown: '20 seconds',
        additionalInfo: [
    ...
    abilities: {
      ...
      tactical: {
        ...
        additionalInfo: [
          ...
          'When shot, the decoy reveals the shooter’s position.'
        ]
      },
      ultimate: {
  ...
  },
  {
    ...
    abilities: {
      passive: {
        ...
        cooldown: '',
        additionalInfo: [
          'Revive Shield strength is based on Newcastle’s Knockdown Shield level.',
